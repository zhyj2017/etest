...
export default {
  ...
  methods: {
    ...
    ...mapMutations(["toggle"]),
    getUserInfo() { //获取用户信息
      let userName = this.$cookies.get("aname")
    ...
    exit() {
      ...
      this.$cookies.remove("aname") //清除cookie
